...
str_attacks = sys.argv[6]

aux = str_attacks.split('_')
attacks = aux[::2]
probabilities = np.array(aux[1::2], dtype='float')
...
for seed in seeds:
    ...
    output_dir = os.path.join(net_dir, str_attacks)
    ...
    ## Perform the attack
    get_index_list_hybrid(g, attacks, probabilities, full_output_name)
